  ...
  .factory('dataSetsServices',function($http,$q,$localStorage,$indexedDB){
    ...
    var dataSetsServices = {
      ...
      getIndividualDataSetFromServer : function(dataSetId){
        ...
        var defer = $q.defer();
        $http.get(baseUrl + '/api/dataSets/'+dataSetId+'.json?fields=name,id,organisationUnits,openFuturePeriods,periodType,formType,dataEntryForm,version,dataElements')
          .success(function(results){
